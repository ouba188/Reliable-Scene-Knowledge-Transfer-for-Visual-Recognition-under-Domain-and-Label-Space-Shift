...
**结论**：
1. 港口间差异**真实**（94% 非噪声），但**港内采集差异更大**（真实 sd 9.78 > 5.83）⇒ **"跨港"的方差主要由"港内采集"主导**。
...
3. 采集轴与港口级 Δ 的相关很弱：`corr(Δ_p, 年份)=+0.22`、`corr(Δ_p, 时刻)=−0.06`；S1B 占比与相对轨道在港间近恒定（不可辩识）。负增益港（Busan/Jebel Ali/LA/NY/Qingdao/Singapore）**不聚集于某个平台或方向**。
